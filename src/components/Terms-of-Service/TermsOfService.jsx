...
const TermsOfService = () => {
  return (
    <div>
      <Heading head={"Terms of Service"} />
      <div className="flex flex-col mt-7 headFont1 w-full max-w-[90%] md:max-w-[70%] mx-auto px-4 justify-between gap-20 pb-[50px] text-left break-words overflow-wrap break-word">
        <div className="leading-relaxed space-y-6 text-sm sm:text-base font-archivo">
          <h2 className="text-xl sm:text-2xl text-gray-200 font-bold">Introduction</h2>
          <p>
          ...
          <h2 className="text-xl sm:text-2xl text-gray-200 font-bold">Personal or Company Data We Process</h2>
          <p>
          ...
          <h2 className="text-xl sm:text-2xl text-gray-200 font-bold">Does Glance Process Special Personal Data?</h2>
          <p>
            No. Glance does not collect sensitive personal data such as health information, criminal records, or ethnic background.
          </p>

          <h2 className="text-xl sm:text-2xl text-gray-200 font-bold">Why We Need Data</h2>
          ...
          <h2 className="text-xl sm:text-2xl text-gray-200 font-bold">Which Rules Apply to Personal Data Processing?</h2>
          <p>
            Glance adheres to applicable data protection laws and may update this policy as necessary to remain compliant.
          </p>

          <h2 className="text-xl sm:text-2xl text-gray-200 font-bold">Data Retention</h2>
          <p>
            Glance retains data only as long as necessary for the purposes for which it was collected.
          </p>

          <h2 className="text-xl sm:text-2xl text-gray-200 font-bold">Data Sharing</h2>
          <p>
          ...
          <h2 className="text-xl sm:text-2xl text-gray-200 font-bold">Cookies and Website Visits</h2>
          <p>
            Our site uses cookies for technical and functional purposes. You can disable cookies through your browser settings.
          </p>

          <h2 className="text-xl sm:text-2xl text-gray-200 font-bold">View, Change, or Delete Your Data</h2>
          <p>
          ...
          <h2 className="text-xl sm:text-2xl text-gray-200 font-bold">Security</h2>
          <p>
          ...
          <h2 className="text-xl sm:text-2xl text-gray-200 font-bold">Your Privacy Rights</h2>
          <p>
          ...
          <h2 className="text-xl sm:text-2xl text-gray-200 font-bold">Questions</h2>
          <p>
